...
function Footer() {
    return (
        <div className='w-full flex gap-5 p-20 h-screen bg-zinc-900'>
            <div className="w-1/2 h-full flex flex-col justify-between font-['Founders_Grotesk_X']">
                <div className="headings">
                    <h1 className='text-[8vw] font-semibold uppercase leading-none -mb-8'>Eye-</h1>
                    <h1 className='text-[8vw] font-semibold uppercase leading-none -mb-8'>Opening</h1>
                </div>
            ...
            <div className="w-1/2 ">
            <h1 className='font-["Founders_Grotesk_X"] text-[8vw] font-semibold uppercase leading-none -mb-8'>Presentations</h1>
            <div className="dets mt-10 font-['Neue_Montreal]">
                <h1 className='ml-2 text-xl'>S:</h1>
                {["Instagram","Behance","Facebook","Linkedin"].map((items,index)=><a key={index} className='block m-2  underline'>{items}</a>)}
            </div>
            <div className="dets-2 flex  justify-between">
                <div className="dets mt-10 font-['Neue_Montreal]">
                    <h1 className='ml-2 text-xl'>L:</h1>
