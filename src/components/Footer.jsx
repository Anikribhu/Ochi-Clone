...
function Footer() {
    return (
        <div className='w-full flex gap-5 max-sm:px-8 p-20 h-screen bg-zinc-900'>
            <div className="w-1/2 h-full flex flex-col justify-between font-['Founders_Grotesk_X']">
                ...
                <h1 className=' text-2xl font-["Neue_Montreal"] tracking-wider font-semibold'>Anik Mallick</h1>
            </div>
            <div className="w-1/2 ">
