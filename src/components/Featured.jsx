        ...
        <div className="w-full py-20">
            ...
            <div className="px-20 max-sm:px-10">
                <div className="cards w-full  max-sm:flex-col max-md:flex-col flex gap-10 pt-10">
                    <motion.div onHoverStart={()=>handleHover(0)} onHoverEnd={()=>handleHoverEnd(0)} className="card-container m-2  relative rounded-2xl w-1/2  max-sm:h-[40vh] max-md:h-[60vh] max-sm:w-full max-md:w-full bg-zinc-800">
