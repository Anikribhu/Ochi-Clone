        ...
        <div className="w-full py-20">
            ...
            <div className="px-20 max-sm:px-10">
                <div className="cards w-full  max-sm:flex-col max-md:flex-col flex gap-10 pt-10">
                    <motion.div onHoverStart={()=>handleHover(0)} onHoverEnd={()=>handleHoverEnd(0)} className="card-container m-2  relative rounded-2xl w-1/2  max-sm:h-[40vh] max-md:h-[60vh] max-sm:w-full max-md:w-full bg-slate-200">
                        <h1 className='text-[#CDEA68] overflow-hidden flex absolute left-full max-sm:left-52 max-md:left-72 -translate-y-1/2 -translate-x-60 top-1/2 z-10  tracking-tight leading-none  text-8xl'>{"GEMINI".split('').map((item, index) =>
